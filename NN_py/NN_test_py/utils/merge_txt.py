...
if __name__ == "__main__":
    ...
    txt1_path = project_root / 'dcx_mini_detected' / 'dcx_mini_detected.txt' # label1
    txt2_path = project_root / 'dcx_mini_cluster' / 'dcx_mini_cluster.txt' # label2
    txt3_path = project_root / 'dcx_mini_distance' / 'circle_distances.txt' # distance
    output_path = project_root / 'dcx_mini_merge' / 'dcx_mini_merge_final.txt'
